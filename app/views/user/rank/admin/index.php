    ...
    <div class="table-responsive">
        <table class="table table-striped table-sm">
            ...
            <?php foreach ($ranks AS $rank): ?>
                <tr>
                    <td><?php echo escape($rank->id); ?></td>
                    <td>
                        <a href="/app/index.php/dashboard/user_ranks/edit?id=<?php echo escape($rank->id); ?>"><?php echo escape($rank->name); ?></a>
                    </td>
                    <td>
                        <a href="/app/index.php/dashboard/user_ranks/edit?id=<?php echo escape($rank->id); ?>"
                           class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="fas fa-edit fa-sm text-white-50"></i> Edit
                        </a>
                        <a href="/app/index.php/dashboard/user_ranks/delete?id=<?php echo escape($rank->id); ?>"
                           class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"
