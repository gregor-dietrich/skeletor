                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle" src="https://cataas.com/cat?type=sq" alt=""/>
                        </a>
                        <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="/app/index.php/user?id=<?php
                            echo $this->usersRepository->findUsername($_SESSION['login'])->id;
                            ?>">
                                <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                Profile
                            </a>
                            <a class="dropdown-item" href="/app/index.php/dashboard/users/edit?id=<?php
                            echo $this->usersRepository->findUsername($_SESSION['login'])->id;
                            ?>">
