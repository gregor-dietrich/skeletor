...
class RanksRepository extends AbstractRepository
{
    ...
    public function insert($name, $post_add, $post_delete, $post_edit, $post_category_add, $post_category_delete, $post_category_edit, $post_comment_add, $post_comment_edit, $post_comment_delete, $user_add, $user_delete, $user_edit, $user_group_add, $user_group_delete, $user_group_edit, $user_rank_add, $user_rank_delete, $user_rank_edit)
    {
        ...
        $stmt = $this->pdo->prepare("INSERT INTO `{$table}` (`name`, `post_add`, `post_delete`, `post_edit`, `post_category_add`, `post_category_delete`, `post_category_edit`, `post_comment_add`, `post_comment_edit`, `post_comment_delete`, `user_add`, `user_delete`, `user_edit`, `user_group_add`, `user_group_delete`, `user_group_edit`, `user_rank_add`, `user_rank_delete`, `user_rank_edit`) VALUES (:name, :post_add, :post_delete, :post_edit, :post_category_add, :post_category_delete, :post_category_edit, :post_comment_add, :post_comment_edit, :post_comment_delete, :user_add, :user_delete, :user_edit, :user_group_add, :user_group_delete, :user_group_edit, :user_rank_add, :user_rank_delete, :user_rank_edit)");
        $stmt->execute([
            'name' => $name,
            'post_add' => $post_add,
    ...
    public function update(RankModel $model)
    {
        ...
        $stmt->execute([
            ...
            'user_group_add' => $model->user_group_add,
            'user_group_delete' => $model->user_group_delete,
            'user_group_edit' => $model->user_group_edit,
